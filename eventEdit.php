...
if ($id == 'new') {
    $event = new Event('new', 'applicant', null, null, null, null, null);
} else {
    $person = retrieve_event($id);
...
<html>
    <head>
        <title>
            Editing <?PHP echo($event->get_name()); ?>
        </title>
            ...
            <div id="content">
                ...
                //in this case, the form has not been submitted, so show it
                   ...
                   // $errors = validate_form($person);  //step one is validation.
                    $errors = TRUE;  //step one is validation.
                    ...
                    if ($errors) {
                       ...
                       // show_errors($errors);
                        ...
                        $event = new Event($event->get_name(), $_POST['last_name'], $_POST['location'], 
